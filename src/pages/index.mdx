...
<div className="space-y-20">
  ...
  <section id="demo-zoom" className="not-prose">
    <header className="mb-6 flex items-center gap-3">
      <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-blue-500 text-white text-sm font-bold shadow">2</span>
  ...
  <section id="demo-switcher" className="not-prose">
    <header className="mb-6 flex items-center gap-3">
      <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-blue-500 text-white text-sm font-bold shadow">3</span>
