...
import demo_input from "../assets/demo_zoom_input.png";
import demo_zoom from "../assets/demo_zoom.gif?url";
...
<div className="space-y-20">
  {/* DEMO 1: 34px → 340px Transition */}
  <section id="demo-fixed" className="not-prose">
    <header className="mb-6 flex items-center gap-3">
      <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-red-500 to-blue-500 text-white text-sm font-bold shadow">1</span>
      <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100">Changing resolution (34px → 340px)</h2>
    </header>

    <div className="mt-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white/60 dark:bg-gray-900/40 p-6 shadow-sm ring-1 ring-black/5">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        <div className="flex flex-col items-center">
          <p className="mb-2 text-lg font-bold text-gray-800 dark:text-gray-200">Input</p>
          <div className="w-[450px] h-[450px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
            <img
              src={demo_input.src ?? demo_input}
              alt="Input (degraded / LR)"
        ...
        <div className="flex flex-col items-center">
          <p className="mb-2 text-lg font-bold text-gray-800 dark:text-gray-200">Output</p>
          <div className="w-[450px] h-[450px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
            <img
              src={demo_zoom}
              alt="Output (zoom animation)"
              className="object-contain w-full h-full"
            />
          </div>
        </div>
  ...
  {/* DEMO 2: ×4 Visualization */}
  <section id="demo-zoom" className="not-prose">
    <header className="mb-6 flex items-center gap-3">
      <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-indigo-500 to-fuchsia-500 text-white text-sm font-bold shadow">2</span>
      <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100">Zoom-In Animation</h2>
    </header>

    <div className="mt-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white/60 dark:bg-gray-900/40 p-6 shadow-sm ring-1 ring-black/5">
      <div className="flex flex-col items-center">
        <p className="mb-2 text-lg font-bold text-gray-800 dark:text-gray-200">  <span>Input</span> <span className="mx-50"></span> <span>Output</span></p>
        <div className="w-[950px] h-[360px] flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md overflow-hidden border border-gray-200 dark:border-gray-800">
          <img src={demo_1} alt="×4 Visualization" className="object-contain w-full h-full rounded-xl shadow-md" />
        </div>
      </div>
    </div>
  </section>
  ...
  {/* DEMO 3: Multi-scale Before/After Comparison */}
  <section id="demo-switcher" className="not-prose">
    <header className="mb-6 flex items-center gap-3">
      <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-indigo-500 to-fuchsia-500 text-white text-sm font-bold shadow">3</span>
      <h2 className="text-2xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100">Multi-scale Before/After Comparison</h2>
    </header>

    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white/60 dark:bg-gray-900/40 p-6 shadow-sm ring-1 ring-black/5">
      <DemoSwitcher
        client:idle
        pairs={[
          {
